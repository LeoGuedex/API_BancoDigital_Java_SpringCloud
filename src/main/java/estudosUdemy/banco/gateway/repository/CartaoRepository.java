...
public interface CartaoRepository extends Repository<Cartao, Long> {
    ...
    Integer isSaldoSuficiente(Integer codigoSegurancaCartao, Integer nroCartao, Double valorCompra);
    ...
    void atualizarSaldo(Integer codigoSegurancaCartao, Integer nroCartao, Double valorCompra);
