...
public interface CartaoRepository extends JpaRepository<Cartao, Long> {
    ...
    Integer isSaldoSuficiente(Integer codigoSegurancaCartao, Integer nroCartao, Integer valorCompra);
    ...
    void atualizarSaldo(Integer codigoSegurancaCartao, Integer nroCartao, Integer valorCompra);
